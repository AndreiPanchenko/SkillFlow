...
public class CourseController {
  ...
  public String saveCourse(
    ...
    if (course.getRegistrationStart() != null && course.getRegistrationEnd() != null &&
      ...
      model.addAttribute("error", "Дата окончания регистрации должна быть после даты начала");
      model.addAttribute("course", course);
      model.addAttribute("experts", expertService.getAllExperts());
      model.addAttribute("statuses", List.of("АКТИВЕН", "НЕ_АКТИВЕН", "В_РАЗРАБОТКЕ"));
      return "courses/form";
    ...
    if (course.getCourseStart() != null && course.getCourseEnd() != null &&
      ...
      model.addAttribute("error", "Дата окончания курса должна быть после дата начала");
      model.addAttribute("course", course);
      model.addAttribute("experts", expertService.getAllExperts());
      model.addAttribute("statuses", List.of("АКТИВЕН", "НЕ_АКТИВЕН", "В_РАЗРАБОТКЕ"));
      return "courses/form";
