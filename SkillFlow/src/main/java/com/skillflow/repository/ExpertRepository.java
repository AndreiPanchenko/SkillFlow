...
public interface ExpertRepository extends JpaRepository<Expert, Long> {
  ...
  /**
   * Находит экспертов по части фамилии (без учета регистра).
   *
   * @param lastName часть фамилии эксперта
   * @return список экспертов, содержащих указанную часть в фамилии
   */
