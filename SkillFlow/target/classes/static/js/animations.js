...
const SkillFlowUtils = {
    ...
    /**
     * Форматирует дату в относительном времени (например, "2 дня назад").
     *
     * @param {string} dateString - строка с датой
...
const SkillFlowDateUtils = {
     ...
     *
     * @param {string} dateString - строка с датой
     * @returns {string} дата в коротком формате
     */
    ...
    /**
     * Проверяет, находится ли дата между двумя другими датами.
     *
     ...
     * @returns {boolean} true если дата находится в диапазоне
     */
